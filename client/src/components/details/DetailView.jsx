    ...
    return (
        <Container>
            ...
            <Box style={{ float: 'right' }}>
                {   
                    (account.username === post.username || account.username === "Kumar Mritunjay" || account.username === "Punya Kakkar" || account.username === "Vishwajeet Patil" || account.username === "Vivek Karmarkar" || account.username === "Anway Nagarkar") &&  
                    <>  
